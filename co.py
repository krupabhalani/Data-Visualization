...
plt.title('Confirmed-Deaths CountryWise')
plt.ioff()
plt.savefig('cd1.png', format='png')
...
plt.ioff()
plt.grid()
plt.savefig('cd2.png', format='png')
...
plt.ioff()
plt.grid()
plt.savefig('cd3.png', format='png')
...
plt.ioff()
plt.grid()
plt.savefig('cd4.png', format='png')

subprocess.call("sc.py", shell=True)